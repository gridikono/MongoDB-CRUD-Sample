...
using MongoDBSampleCRUD.Services;
using Microsoft.AspNetCore.HttpsPolicy;
using MongoDBSampleCRUD.Services.Contracts;
using MongoDBSampleCRUD.Services.Concrete;
using MongoDBSampleCRUD.Services.DI;
using MongoDBSampleCRUD.DbSettings.Concrete;
using MongoDBSampleCRUD.DbSettings.Contracts;

namespace MongoDBSampleCRUD
{
